...
*/
function confirmar_solicitud(contrincante_socket_id, contrincante, contrincante_color, 
	socket_id, username, mi_color) {
	
	socket.emit('confirmar_solicitud', contrincante_socket_id, contrincante, 
		contrincante_color, socket_id, username, mi_color);
...
function cargar_escuchadores() {
	...
	socket.on('solicitud_confirmada', function(socket_id, username, mi_color, 
		contrincante_socket_id, contrincante, contrincante_color) {
